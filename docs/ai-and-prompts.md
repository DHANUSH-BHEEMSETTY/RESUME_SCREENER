...
MatchSchema = z.object({
  ...
  matchedSkills: z.array(z.object({ skill: z.string(), evidence: z.string() })),
  missingSkills: z.array(z.object({ skill: z.string(), evidence: z.string() })),
  preferredSkillsMatched: z.array(z.object({ skill: z.string(), evidence: z.string() })),
